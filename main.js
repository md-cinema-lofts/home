...
ro = [
  ...
  "Puteți emite o rambursare cu o oră înainte de sesiune prin intermediul asistenței tehnice de pe site. ",
...
ru = [
  ...
  "На время пандемии заведение работает по системе электронного учета. Всех посетителейпринимаем только по предварительной электронной записи. Согласно 54-ФЗ, любойнезарегистрированный посетитель привлекается к ответственности и будет платить штраф.n                        ",
  "Можно ли оформить возврат средств?",
  "Оформить возврат средств можно за час до сеанса через техническую поддержку на сайте.n                        ",
  "Я оплатил,что дальше?",
  "После оплаты в течение 1 часа вам на номер придёт СМС с спец. кодом который вы сообщите привходе в зал. Если же СМС не пришло, обратитесь к поддержке на сайте. ",
