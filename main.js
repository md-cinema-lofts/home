...
ro = [
  ...
  "Timp",
  "Abordare",
  "Moscova, bulevardul Khodynsky. 4, SEC AVIAPARK ",
  "Servicii aditionale",
  ...
  "Servicii aditionale",
  "Anulați rezervarea",
  "De ce această metodă de plată?",

  // 5
  "În momentul pandemiei, instituția funcționează pe un sistem de înregistrare electronică. Toți vizitatorii sunt acceptați doar prin înregistrare electronică prealabilă. Conform 54-FZ, orice vizitator neînregistrat va fi urmărit penal și va plăti o amendă . ",
  "Pot primi o rambursare?",
  "Puteți emite o rambursare cu o oră înainte de sesiune prin intermediul asistenței tehnice de pe site. \ n",
  "Am plătit, ce urmează?",
  "După plata în termen de 1 oră, veți primi un SMS cu un cod special pe care îl veți informa la intrarea în sală. Dacă nu primiți un SMS, vă rugăm să contactați asistența de pe site.",
  "Pot să aduc mâncare și băutură?",
  "Această problemă trebuie discutată personal",
  "Maria Popescu",
  "Vrem să mulțumim personalului pentru munca bună și senzațiile plăcute pe care le-au dat. Mulțumiri speciale pentru promptitudine, când am plecat am uitat unitatea flash, am sunat imediat și am informat despre asta. Suntem foarte mulțumiți , cu siguranță ne vom uita din nou !!!!! Îl recomand. ",
  "Elena Ionescu",
  "Am dansat din suflet, ne-am îmbătat (am strigat), am făcut poze și am fost foarte mulțumiți! Narghilea excelentă! Administratori foarte atenți și mulțumesc fotografului Alexander pentru că mi-a capturat petrecerea burlacilor =) Fondue, băuturi - suficient = = Fete ! Dacă decideți să mergeți la o petrecere a burlacilor, atunci vă sfătuiesc să includeți înregistrări din jocul Just Dance! Vă garantez că va fi atât de distractiv😍 ",
  "Mihai Radu",
  "Loc minunat !!) Am fost alături de tine ieri cu o fată, mi-a plăcut totul, personal foarte confortabil și prietenos. Vom veni din nou la tine și îl voi recomanda prietenilor mei!) 👍👍",
  "Alexandra Lapa",
  "Totul a fost bombardant de răcoros, m-am distrat 100% cu prietenii mei !! Recepționerul a fost foarte politicos, ospitalier și dulce 🎉😊 Sala a fost decorată la cerere, ne-au întâlnit la jumătatea drumului, în general, totul a fost doar minunat 👍🏻👍🏻 Mulțumesc că ești uriaș ❤💋🙏🏻 sigur vom veni la tine))",
  "Unde suntem",
  "Moscova, bulevardul Khodynsky. 4, SEC AVIAPARK"
]
...
ru = [
  ...
  "Время",
  "Адрес",
  " г. Москва, Ходынский б-р 4, ТРЦ «АВИАПАРК» ",
  "Дополнительные услуги",
  "Отменить бронирование",
  ...
  "\n                            На время пандемии заведение работает по системе электронного учета. Всех посетителей\n                            принимаем только по предварительной электронной записи. Согласно 54-ФЗ, любой\n                            незарегистрированный посетитель привлекается к ответственности и будет платить штраф.\n                        ",
  "Можно ли оформить возврат средств?",
  "\n                            Оформить возврат средств можно за час до сеанса через техническую поддержку на сайте.\n                        ",
  "Я оплатил,что дальше?",
  "\n                            После оплаты в течение 1 часа вам на номер придёт СМС с спец. кодом который вы сообщите при\n                            входе в зал. Если же СМС не пришло, обратитесь к поддержке на сайте. ",
  "Можно ли приносить еду и выпивку?",
  "\n                            Этот вопрос нужно обсудить лично ",
  "Maria Popescu",
  "Хотим сказать большое спасибо персоналу за хорошую работу и подаренные приятные ощущения. Отдельное спасибо за оперативность, когда уходили забыли флешку, сразу позвонили и сообщили об этом. Мы очень довольные, обязательно заглянем ещё!!!!! Рекомендую.",
  "Elena Ionescu",
  ...
  "Mihai Radu",
  "Отличное место !!) был вчера с девушкой у вас, все понравилось, очень уютно и персонал дружелюбный. Придем к вам еще раз обязательно и друзьям буду рекомендовать!)👍👍",
  "Alexandra Lapa",
  "Все было бомбически круто , я повеселилась с друзьями на все 100%!! Девушка-администратор очень была вежливая,гостеприимная и милая 🎉😊зал нам украсили , как просили, нам пошли навстречу , в общем всё было просто замечательно 👍🏻👍🏻Спасибо вам огромное ❤💋🙏🏻 обязательно придём к вам ещё ))",
  "Где мы находимся",
  "г. Москва, Ходынский б-р 4, ТРЦ «АВИАПАРК»"
]
...
checkboxes[0].addEventListener('change', function () {
  (this.checked) ?
    getTableBtns[0].innerText = ` A rezerva - 750 MDL `
    :
    getTableBtns[0].innerText = ` A rezerva - 600 MDL `
})

checkboxes[1].addEventListener('change', function () {
  (this.checked) ?
    getTableBtns[1].innerText = ` A rezerva - 1150 MDL `
    :
    getTableBtns[1].innerText = ` A rezerva - 1000 MDL `
})

checkboxes[2].addEventListener('change', function () {
  (this.checked) ?
    getTableBtns[2].innerText = ` A rezerva - 1750 MDL `
    :
    getTableBtns[2].innerText = ` A rezerva - 1600 MDL `
})
